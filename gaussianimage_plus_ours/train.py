...
def main(args):
    ...
    log_dir = (
            f"./checkpoints/{args.data_name}/{args.model_name}_M{args.max_num_points}_N{args.num_points}{'_SLV' if args.SLV_init else ''}_R{args.radius_clip}{'_add' if args.adaptive_add else ''}" +
    ...
    if args.data_name == "data_200":
        image_length, start = 5, 0
    ...
    for image_path in image_paths:
        ...
        model_path = Path(model_path) / stem / "gaussian_model.pth.tar"
